  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center md:flex-row">
        <div className=" h-auto border-opacity-50">
          <div className=" m-2 flex-grow card glass">
            <figure>
              <iframe
          ...
          <section className="overflow-hidden">
            ...
            <div className="bg-secondary grid flex-grow card m-2">
              <div className="card-body">
                <h6 className="card-title">Fotos oficiais do evento</h6>
                <button className="btn btn-active btn-primary">
                  {" "}
                  Clique aqui
                  <a href="https://photos.app.goo.gl/9NyXp8tYsXHi4RL87"></a>
                </button>
              </div>
            </div>
          </section>
